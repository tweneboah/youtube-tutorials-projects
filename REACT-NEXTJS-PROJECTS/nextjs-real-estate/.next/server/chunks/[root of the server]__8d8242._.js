...
"[project]/app/api/properties/my-listings/route.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function verifyAuth(request) {
    ...
    try {
        ...
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$user$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(userId).select('_id');
        if (!user) {
            return {
...
async function GET(request) {
    try {
        ...
        const properties = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$property$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({
            owner: auth.userId
        }).populate('owner', 'name email phone').sort({
            createdAt: -1
        }).lean();
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__8d8242._.js.map