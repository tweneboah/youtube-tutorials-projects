(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["chunks/[root of the server]__2563dc._.js", {
...
"[project]/lib/jwt.js [middleware] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const signToken = (payload)=>{
    try {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["default"].sign(payload, JWT_SECRET, {
            expiresIn: '30d'
        });
    } catch (error) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$jwt$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/lib/jwt.js [middleware] (ecmascript)");
...
async function middleware(request) {
    ...
    if (isProtectedRoute) {
        ...
        try {
            // Verify the token
            const decoded = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$jwt$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["verifyToken"])(token);
            if (!decoded) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__2563dc._.js.map